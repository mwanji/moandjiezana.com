...
These are necessary only to send emails via Mailgun. No pitfalls here, if there are no other MX records. You can enter the hostname and priority as given by Mailgun.
